...
/****************** Set your values ******************/
var keyFileName = 'AuthKey_TU1234ABC.p8'; // Download from https://developer.apple.com/account/ios/authkey/
var keyId = 'TU1234ABC'; // Can be found at: https://developer.apple.com/account/ios/authkey/
...
if (keyFileName == '' || keyId == '' || teamId == '') {
	console.error('ERROR: Missing required parameters.');
	console.error('ERROR: Make sure you have entered your keyFileName, keyId and teamId.');
	return;
}
...
versionRouter.post('/validate', function(req, response) {
	console.log('\n\n\n\n\n');
